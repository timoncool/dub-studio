...
Оригинал (слева) → дубляж на русский, текст на экране **локализован на месте** (справа):

<img src="docs/example.png" width="640" alt="Оригинал (англ.) против русского дубляжа — экранный текст локализован на месте"/>

▶ Посмотреть клипы (со звуком): **[Оригинал](docs/example_original.mp4)** · **[Дубляж — RU](docs/example_dub.mp4)**
